...
import { ImageBboxTaxonomyList } from "../examples/image_bbox_taxonomy_list";
...
// Switch this to try different example configs in the standalone editor dev server.
const data = ImageBboxTaxonomyList;
